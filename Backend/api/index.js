...
const { insertIntoDatabase, searchDatabase, connectDatabase } = require("./database.js");
...
app.get("/", (req, res) => {
  res.sendFile(
    path.join(
      __dirname,
      "../../Frontend/build/static/index.html"
    )
  );
});
...
app.get("/url-shortner/*", async (req, res) => {
...
app.get("/404",(req,res) => {
  ...
  res.sendFile(path.join(__dirname, "../../Frontend/build/static/error_404.html"));
})
